...
const samborsky = document.getElementById("samborsky");
const michelin = document.getElementById("michelin");
const riksha = document.getElementById("riksha");
const samborska = document.getElementById("samborska");
const michael = document.getElementById("michael");

const arrTestimonial = [john, samborsky, michelin, riksha, samborska, michael];

function setTestimonials() {
  shuffle(arrTestimonial);
  ...
  for (let i = 0; i < 11; i++) {
    ...
    if (i < arrTestimonial.length) {
      div.innerHTML = arrTestimonial[i].innerHTML;
    } else {
      div.innerHTML = arrTestimonial[i % arrTestimonial.length].innerHTML;
    }
...
testimonialCross.addEventListener("click", function () {
  testimonialPopup.classList.remove("active");
  shadow.classList.toggle("popup");
});
...
console.log(
  ...
  "✔️ Затемнение и кнопка закрытия присутствуют\n",
  ...
  "✔️ Все неоходимые элементы присутствуют, лишние элементы отсутствуют\n",
  ...
  "✔️ Элемент Contact Us интерактивный\n",
  "✔️ Элемент Designed by © интерактивный и работает как ссылка на страницу Figma\n",
  "✔️ Один элемента <h1>\n\n",
